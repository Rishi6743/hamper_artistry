...
const Intro = () => {
    ...
    const handleClick = () => {
        window.open("https://api.whatsapp.com/message/DZZ4NSMPPGM5E1?autoload=1&app_absent=0", "_blank");
                    ...
                    <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                        <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-center md:text-left mb-16 md:mb-0 items-center text-center">
                            ...
                            <div class="flex justify-center">
                                <button onClick={handleClick} class="inline-flex text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded text-lg">
                                    Contact us
                                </button>
                            </div>
                        </div>
