            ...
            <div class="bg-white dark:bg-gray-900">
                <div class="flex justify-center h-screen">
                    <div class="hidden bg-cover lg:block lg:w-2/3" style={{
                        backgroundImage: `url("https://www.ehc.co.uk/pub/media/catalog/product/cache/f46f95e8a9dd82090b2698940982fdd4/w/o/woodluv-create-your-own-rectangular-wicker-gift-hamper-kit-use-for-christmas-presents-christening-wedding-baby-shower-valentine-day-or-birthday-gift_1.jpg")`,
                        height: "70vh",
                        backgroudPosition: "cover"
                    }}>
